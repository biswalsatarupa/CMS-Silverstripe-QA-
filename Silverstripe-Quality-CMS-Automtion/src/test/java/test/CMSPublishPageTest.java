...
public class CMSPublishPageTest extends BaseTest {
	...
	public void verifyPageSaveInSilverstripeCMS(ITestContext context,String UserName,String Password, String pageType) throws Throwable {
		driver = new DriverUtils().getDriver();
