...
public class CMSSavePageTest extends BaseTest {
	...
	/*
	 *This method will verify the Save Page Feature  in Silverstripe CMS 
	 */
	@Test(dataProvider = "getTestData",priority = 1, enabled = true,description= "To verify the Save Page feature in Silverstripe CMS")
	public void verifyPagePublishInSilverstripeCMS(ITestContext context,String UserName,String Password, String pageType) throws Throwable {
		driver = new DriverUtils().getDriver();
